...
namespace ActiveRecord\test;

use ActiveRecord\base\ArrayAccessTrait;
...
abstract class BaseActiveFixture extends DbFixture implements \IteratorAggregate, \ArrayAccess, \Countable
{
    ...
    /**
     * @var \ActiveRecord\db\ActiveRecord[] the loaded AR models
     */
    private $_models = [];
     ...
     * @return null|\ActiveRecord\db\ActiveRecord the AR model, or null if the model cannot be found in the database
     * @throws \ActiveRecord\base\InvalidConfigException if [[modelClass]] is not set.
     */
