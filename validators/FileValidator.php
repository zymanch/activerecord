...
use ActiveRecord\helpers\FileHelper;
...
class FileValidator extends Validator
{
     ...
     *   with [[\ActiveRecord\i18n\Formatter::asShortSize()|Formatter::asShortSize()]]
     */
    public $tooBig;
    /**
    ...
    public function init()
    {
        ...
        if ($this->uploadRequired === null) {
            $this->uploadRequired = 'Please upload a file.';
        }
                ...
                if ($this->maxSize !== null && $value->size > $this->getSizeLimit()) {
                    return [
                        ...
                        [
                            ...
                            'formattedLimit' => round($this->getSizeLimit()/1024).'kb',
                        ],
                    ];
                    ...
                    return [
                        ...
                        [
                            'file' => $value->name,
                            'limit' => $this->minSize,
                            'formattedLimit' => round($this->minSize/1024).'kb',
                        ],
                    ];
