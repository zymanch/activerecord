...
use ActiveRecord\web\UploadedFile;
...
class ImageValidator extends FileValidator
{
    ...
    public function init()
    {
        ...
        if ($this->notImage === null) {
            $this->notImage = 'The file "{file}" is not an image.';
        }
        if ($this->underWidth === null) {
            $this->underWidth = 'The image "{file}" is too small. The width cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.';
        }
        if ($this->underHeight === null) {
            $this->underHeight = 'The image "{file}" is too small. The height cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.';
        }
        if ($this->overWidth === null) {
            $this->overWidth = 'The image "{file}" is too large. The width cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.';
        }
        if ($this->overHeight === null) {
            $this->overHeight = 'The image "{file}" is too large. The height cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.';
        }
    }
