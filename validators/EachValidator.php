...
class EachValidator extends Validator
{
     ...
     * It should be specified in the same format as at [[\ActiveRecord\base\Model::rules()]], except it should not
     ...
     * ```
     *
     * Please refer to [[\ActiveRecord\base\Model::rules()]] for more details.
     */
    public $rule;
    /**
